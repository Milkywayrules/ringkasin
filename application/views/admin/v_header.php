...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if ($active == 'url') { echo "active"; } ?>">
        <a class="nav-link " href="<?php echo base_url('admin/url') ?>" data-toggle="" data-target="" aria-expanded="" aria-controls="">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Create Short URL</span>
        </a>
      </li>

      <li class="nav-item <?php if ($active == 'add') { echo "active"; } ?>">
        <a class="nav-link " href="<?php echo base_url('admin/add') ?>" data-toggle="" data-target="" aria-expanded="" aria-controls="">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item <?php if ( ($active == 'manageAccounts') or ($active == 'manageUrl') ) { echo "active"; } ?>">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?php if ($active == 'manageAccounts') { echo "active"; } ?>" href="<?php echo base_url('admin/manage/accounts') ?>">Accounts</a>
            <a class="collapse-item <?php if ($active == 'manageUrl') { echo "active"; } ?>" href="<?php echo base_url('admin/manage/url') ?>">URLs</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url('admin/inbox') ?>">Read More Messages</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo 'Hi, '.$this->session->userdata('name') ?></span>
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/img/q_logo_1.png') ?>">
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo base_url('admin/inbox') ?>">
