...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('u/dashboard') ?>">
      ...
      <li class="nav-item <?php if ($active == 'dashboard') { echo "active"; } ?>">
        <a class="nav-link" href=<?php echo base_url('u/dashboard') ?>>
      ...
      <li class="nav-item <?php if ($active == 'create') { echo "active"; } ?>">
        <a class="nav-link " href="<?php echo base_url('u/create') ?>" data-toggle="" data-target="" aria-expanded="" aria-controls="">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item <?php if ( ($active == 'accounts') or ($active == 'url') ) { echo "active"; } ?>">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?php if ($active == 'url') { echo "active"; } ?>" href="<?php echo base_url('u/manage/url') ?>">URLs</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo base_url('u/inbox') ?>">Read More Messages</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/img/avatars/avatar0.jpg') ?>">
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo base_url('u/inbox') ?>">
                  <i class="fas fa-envelope fa-sm fa-fw mr-2 text-gray-400"></i>
                  Inbox
                </a>
                <a class="dropdown-item" href="<?php echo base_url('u/profile') ?>">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url('u/settings') ?>">
